...
const WeeklyAvailability = () => {
  ...
  useEffect(() => {
    ...
    const handleCloseCopyDropdown = (e) => {
      // console.log(copyIcon.current);
      // console.log(e.target);
      // console.log(copyIcon.current.contains(e.target));
      if(!copyIcon.current.contains(e.target)){
        setDowId(null);
      }else{
              ...
              {availability &&
                ...
                ? (
                  <div className="flex gap-3 md:gap-1">
                    <button
                      onClick={(e) => handleMethod(e, "add", Object.keys(eachObj)[0])}
                    ...
                    <div className="relative">
                      <button
                        id={Object.keys(eachObj)[0]}
                        ref={copyIcon}
                        onClick={(e) => handleMethod(e, "copy", Object.keys(eachObj)[0])}
                        className="flex justify-center items-center w-7 h-7 hover:bg-gray-200 hover:rounded-full"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-gray-600" >
