...
const AppointmentCollapse = ({eachAppointment}) => {
  ...
  const appointmentDow = moment(eachAppointment.appointmentDateTime.date).format('dddd')
  const appointmentDate = moment(eachAppointment.appointmentDateTime.date).format('MMM DD, YYYY')
  ...
  return (
    ...
    >
      <HashLink smooth to="#appointmentBtns" className="text-xl font-medium flex items-center w-full py-3 mx-auto justify-evenly">
      ...
      {isCollapseOpen &&                   
        <div className="p-3 mx-auto">
          ...
          <div id="appointmentBtns" className="flex items-center justify-center my-2 gap-1">
            <button
